...
func (r *SomeNameReconciler) ensureSecurityContextConstraints(ctx context.Context, someName *v1alpha2.SomeName) (*securityv1.SecurityContextConstraints, error) {
	desired := r.desiredSecurityContextConstraints(someName)
...
func (r *SomeNameReconciler) currentSecurityContextConstraints(ctx context.Context) (*securityv1.SecurityContextConstraints, error) {
...
func (r *SomeNameReconciler) createSecurityContextConstraints(ctx context.Context, scc *securityv1.SecurityContextConstraints) error {
	return r.Client.Create(ctx, scc)
}

// desiredSecurityContextConstraints returns the desired securitycontextconstraints.
func (r *SomeNameReconciler) desiredSecurityContextConstraints(someName *v1alpha2.SomeName) *securityv1.SecurityContextConstraints {
	scc := &securityv1.SecurityContextConstraints{
...
func (r *SomeNameReconciler) updateSecurityContextConstraintes(ctx context.Context, current, desired *securityv1.SecurityContextConstraints) (bool, error) {
...
func (r *SomeNameReconciler) deleteSecurityContextConstraints(someName *v1alpha2.SomeName) error {
	scc := &securityv1.SecurityContextConstraints{}
	scc.Name = sccName
