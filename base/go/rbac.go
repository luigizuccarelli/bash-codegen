...
import (
	...
	v1alpha2 "github.com/openshift/some-operator/api/v1alpha2"
)

const (
	// cluster role is created via operator bundle, refer to config/rbac/operand_role.yaml
	clusterRoleName        = "some-operator-agent"
	clusterRoleBindingName = "some-agent"
)

func (r *SomeNameReconciler) verifyClusterRole(ctx context.Context) (bool, error) {
...
func (r *SomeNameReconciler) ensureClusterRoleBinding(ctx context.Context, someName *v1alpha2.SomeName, saName, saNamespace string) (*rbacv1.ClusterRoleBinding, error) {
	desired := r.desiredClusterRoleBinding(someName, saName, saNamespace)
...
func (r *SomeNameReconciler) currentClusterRoleBinding(ctx context.Context) (*rbacv1.ClusterRoleBinding, error) {
...
func (r *SomeNameReconciler) createClusterRoleBinding(ctx context.Context, crb *rbacv1.ClusterRoleBinding) error {
	return r.Create(ctx, crb)
}

// desiredClusterRoleBinding returns a clusterrolebinding object
func (r *SomeNameReconciler) desiredClusterRoleBinding(someName *v1alpha2.SomeName, saName, ns string) *rbacv1.ClusterRoleBinding {
...
func (r *SomeNameReconciler) updateClusterRoleBinding(ctx context.Context, current *rbacv1.ClusterRoleBinding, desired *rbacv1.ClusterRoleBinding) (bool, error) {
...
func (r *SomeNameReconciler) deleteClusterRoleBinding(someName *v1alpha2.SomeName) error {
	crb := &rbacv1.ClusterRoleBinding{}
