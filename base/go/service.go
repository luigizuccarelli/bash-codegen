...
func (r *SomeNameReconciler) ensureService(ctx context.Context, someName *v1alpha2.SomeName, ns string) (*corev1.Service, error) {
	nameSpace := types.NamespacedName{Namespace: ns, Name: opctrl.AgentServiceName}

	desired := r.desiredService(someName, ns)
...
func (r *SomeNameReconciler) currentService(ctx context.Context, nameSpace types.NamespacedName) (*corev1.Service, error) {
	svc := &corev1.Service{}
...
func (r *SomeNameReconciler) createService(ctx context.Context, svc *corev1.Service) error {
	return r.Create(ctx, svc)
}

func (r *SomeNameReconciler) updateService(ctx context.Context, current, desired *corev1.Service) (bool, error) {
...
func (r *SomeNameReconciler) desiredService(someName *v1alpha2.SomeName, ns string) *corev1.Service {
